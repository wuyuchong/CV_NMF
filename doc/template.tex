...
\textsc{\Large 探索性数据分析课程}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries 图像数据降维分析报告}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\textsc{\large 2021210793}\\[0.5cm] % Minor heading such as course title
\textsc{\large email@wuyuchong.com}\\[0.5cm] % Minor heading such as course title
\textsc{\large 指导老师：刘苗}\\[0.5cm] % Minor heading such as course title
\end{center}
...
{\large 2021年11月26日}\\[2cm] % Date, change the \today to a set date if you want to be precise
